...
--    self:print("|  "..v.sortable_name.."  |  "..v.id.."  |  "..uid.."  |")
  ...
  for fields in f:lines() do
      ...
      self.projects[jj.proj_id].assessor      = self.projects[jj.proj_id].assessor      or jj.assessor
      self.projects[jj.proj_id].assessor_id   = self.projects[jj.proj_id].assessor_id   or jj.assessor_id
